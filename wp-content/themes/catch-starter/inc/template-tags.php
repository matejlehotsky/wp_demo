...
function catch_starter_footer_content() {
	...
	$footer_right_content = str_replace( $search, $replace, get_theme_mod( 'catch_starter_footer_content_right', $theme_data->get( 'Name' ) . '&nbsp;' . esc_html__( 'by', 'catch-starter' ) . '&nbsp;<a target="_blank" href="' . esc_url( $theme_data->get( 'AuthorURI' ) ) . '">' . esc_html( $theme_data->get( 'Author' ) ) . '</a>' ) );
